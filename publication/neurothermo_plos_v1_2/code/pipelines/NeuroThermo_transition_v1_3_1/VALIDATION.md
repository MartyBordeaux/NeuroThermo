...
## v1.3.1 figure hotfix validation

The three boundary plots are regenerated from `component_boundary_summary_v1_3.csv`; each must contain three non-empty mode curves (`combined`, `kappa_only`, `J_only`) and a majority-support panel. No HR state is resimulated.
